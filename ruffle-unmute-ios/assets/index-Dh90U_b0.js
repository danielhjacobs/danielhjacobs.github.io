const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ruffle_web-wasm_extensions-Dv4AudRj.js","./ruffle-imports-CztXuSei.js","./ruffle_web-Dv4AudRj.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var td;function fm(){if(td)return Hr;td=1;var s=Xl(),i=Symbol.for("react.element"),o=Symbol.for("react.fragment"),u=Object.prototype.hasOwnProperty,d=s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,f={key:!0,ref:!0,__self:!0,__source:!0};function v(g,x,R){var O,$={},J=null,Q=null;R!==void 0&&(J=""+R),x.key!==void 0&&(J=""+x.key),x.ref!==void 0&&(Q=x.ref);for(O in x)u.call(x,O)&&!f.hasOwnProperty(O)&&($[O]=x[O]);if(g&&g.defaultProps)for(O in x=g.defaultProps,x)$[O]===void 0&&($[O]=x[O]);return{$$typeof:i,type:g,key:J,ref:Q,props:$,_owner:d.current}}return Hr.Fragment=o,Hr.jsx=v,Hr.jsxs=v,Hr}var rd;function pm(){return rd||(rd=1,yl.exports=fm()),yl.exports}var D=pm(),Qe=Xl();const ql=Jd(Qe);var va={},bl={exports:{}},ln={},xl={exports:{}},Sl={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var id;function mm(){return id||(id=1,function(s){function i(A,B){var M=A.length;A.push(B);e:for(;0<M;){var w=M-1>>>1,j=A[w];if(0<d(j,B))A[w]=B,A[M]=j,M=w;else break e}}function o(A){return A.length===0?null:A[0]}function u(A){if(A.length===0)return null;var B=A[0],M=A.pop();if(M!==B){A[0]=M;e:for(var w=0,j=A.length,G=j>>>1;w<G;){var X=2*(w+1)-1,ie=A[X],ae=X+1,he=A[ae];if(0>d(ie,M))ae<j&&0>d(he,ie)?(A[w]=he,A[ae]=M,w=ae):(A[w]=ie,A[X]=M,w=X);else if(ae<j&&0>d(he,M))A[w]=he,A[ae]=M,w=ae;else break e}}return B}function d(A,B){var M=A.sortIndex-B.sortIndex;return M!==0?M:A.id-B.id}if(typeof performance=="object"&&typeof performance.now=="function"){var f=performance;s.unstable_now=function(){return f.now()}}else{var v=Date,g=v.now();s.unstable_now=function(){return v.now()-g}}var x=[],R=[],O=1,$=null,J=3,Q=!1,ne=!1,H=!1,Z=typeof setTimeout=="function"?setTimeout:null,Me=typeof clearTimeout=="function"?clearTimeout:null,De=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function fe(A){for(var B=o(R);B!==null;){if(B.callback===null)u(R);else if(B.startTime<=A)u(R),B.sortIndex=B.expirationTime,i(x,B);else break;B=o(R)}}function K(A){if(H=!1,fe(A),!ne)if(o(x)!==null)ne=!0,en(Se);else{var B=o(R);B!==null&&Pe(K,B.startTime-A)}}function Se(A,B){ne=!1,H&&(H=!1,Me(pe),pe=-1),Q=!0;var M=J;try{for(fe(B),$=o(x);$!==null&&(!($.expirationTime>B)||A&&!re());){var w=$.callback;if(typeof w=="function"){$.callback=null,J=$.priorityLevel;var j=w($.expirationTime<=B);B=s.unstable_now(),typeof j=="function"?$.callback=j:$===o(x)&&u(x),fe(B)}else u(x);$=o(x)}if($!==null)var G=!0;else{var X=o(R);X!==null&&Pe(K,X.startTime-B),G=!1}return G}finally{$=null,J=M,Q=!1}}var Re=!1,le=null,pe=-1,_=5,q=-1;function re(){return!(s.unstable_now()-q<_)}function qe(){if(le!==null){var A=s.unstable_now();q=A;var B=!0;try{B=le(!0,A)}finally{B?Ie():(Re=!1,le=null)}}else Re=!1}var Ie;if(typeof De=="function")Ie=function(){De(qe)};else if(typeof MessageChannel<"u"){var Ce=new MessageChannel,Cn=Ce.port2;Ce.port1.onmessage=qe,Ie=function(){Cn.postMessage(null)}}else Ie=function(){Z(qe,0)};function en(A){le=A,Re||(Re=!0,Ie())}function Pe(A,B){pe=Z(function(){A(s.unstable_now())},B)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(A){A.callback=null},s.unstable_continueExecution=function(){ne||Q||(ne=!0,en(Se))},s.unstable_forceFrameRate=function(A){0>A||125<A?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):_=0<A?Math.floor(1e3/A):5},s.unstable_getCurrentPriorityLevel=function(){return J},s.unstable_getFirstCallbackNode=function(){return o(x)},s.unstable_next=function(A){switch(J){case 1:case 2:case 3:var B=3;break;default:B=J}var M=J;J=B;try{return A()}finally{J=M}},s.unstable_pauseExecution=function(){},s.unstable_requestPaint=function(){},s.unstable_runWithPriority=function(A,B){switch(A){case 1:case 2:case 3:case 4:case 5:break;default:A=3}var M=J;J=A;try{return B()}finally{J=M}},s.unstable_scheduleCallback=function(A,B,M){var w=s.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?w+M:w):M=w,A){case 1:var j=-1;break;case 2:j=250;break;case 5:j=1073741823;break;case 4:j=1e4;break;default:j=5e3}return j=M+j,A={id:O++,callback:B,priorityLevel:A,startTime:M,expirationTime:j,sortIndex:-1},M>w?(A.sortIndex=M,i(R,A),o(x)===null&&A===o(R)&&(H?(Me(pe),pe=-1):H=!0,Pe(K,M-w))):(A.sortIndex=j,i(x,A),ne||Q||(ne=!0,en(Se))),A},s.unstable_shouldYield=re,s.unstable_wrapCallback=function(A){var B=J;return function(){var M=J;J=B;try{return A.apply(this,arguments)}finally{J=M}}}}(Sl)),Sl}var ad;function hm(){return ad||(ad=1,xl.exports=mm()),xl.exports}/**
 * @license React
